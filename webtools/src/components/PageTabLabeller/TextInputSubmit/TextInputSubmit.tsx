...
import { LabellerCategory, labellers } from "../../../domain";
// {{{ASSETS}}}
import { IconFilter, IconFilterFilled, IconQuestionMark, IconX } from "@tabler/icons-react";
      ...
      <Menu.Dropdown>
        ...
        <Menu.Item component="div">
          <Checkbox
            ...
            label="Whole word"
            name="WHOLE_WORD"
            onChange={(event) => updateInputSettings({ wholeWord: event.currentTarget.checked })}
        ...
        <Menu.Item component="div">
          <Checkbox
            ...
            label="Case sensitve"
            name="CASE_SENSITIVE"
            onChange={(event) => updateInputSettings({caseSensitive: event.currentTarget.checked })}
            styles={{ root: { width: "100%" }, labelWrapper: { width: "100%" } }}
          />
        </Menu.Item>
        <Menu.Divider />
