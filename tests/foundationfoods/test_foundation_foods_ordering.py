...
def p_mulitple_names():
    ...
    """
    sentence = "2 cups olive or sunflower oil"
    tokens = ["2", "cup", "olive", "or", "sunflower", "oil"]
...
class TestPostProcessor_ordering:
    def test_split_ingredient_name(self, p_mulitple_names):
        ...
        """
        assert p_mulitple_names.parsed.name[0].text == "olive oil"
        assert p_mulitple_names.parsed.foundation_foods[0].fdc_id == 2710186
